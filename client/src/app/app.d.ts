...
declare module 'app/app.screens' {
	...
	import { loading_PhonePortrait } from 'app/../pages/loading/PhonePortrait/loading';
	import { takephoto_PhonePortrait } from 'app/../pages/takephoto/PhonePortrait/takephoto';
	import { readme_PhonePortrait } from 'app/../pages/readme/PhonePortrait/readme';
	export class Screens {
	    static declarations: typeof MenuComponent[];
	    static mapping: {
	        'loading': {
	            PhonePortrait: typeof loading_PhonePortrait;
	        };
	        'takephoto': {
	            PhonePortrait: typeof takephoto_PhonePortrait;
	        };
	        'readme': {
	            PhonePortrait: typeof readme_PhonePortrait;
	        };
	    };
	}
